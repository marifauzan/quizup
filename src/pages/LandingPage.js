  ...
  return (
    <div className="flex">
        ...
        {quiz.length === 0 ? (
            ...
            <span class="indicator-item mt-10 mr-8 px-4 py-5 font-semibold badge badge-primary bg-gradient-to-r from-purple-500 to-sky-500 border-none drop-shadow-md">try me</span>
                <QuizCard
                    key={quiz.id}
                    id={quiz.id}
                    title={quiz.title}
            ...
            <div class="bg-blue-50 drop-shadow-md w-52 h-70 rounded-lg mb-4 grid place-items-center">
              <svg class="w-8 h-8 mt-8" fill="lightgray" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z" clip-rule="evenodd"></path></svg>
